...
measured to tighten. The +0.40 ft local enhancement is treated as
applying at this landmark too, but note this is an extrapolation:
the offset was fit primarily from drain-backflow-era events at street
level, and at 5.08 NAVD88 we're firmly in direct-inundation territory.
The bay-to-gauge offset still holds physically; whether the bay-to-
342-Bay offset is exactly the same is an open question with no
calibration data above ~7.6 ft MLLW.
