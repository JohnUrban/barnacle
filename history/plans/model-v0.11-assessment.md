...
the v0.10.2 baseline. The initial read-only assessment is recorded in
...
the tide. The independently proved `_pluvial_fill` continuity correction was
promoted alone as v0.10.3, with exact goldens; every other candidate remains
held. This document remains a queue, not a model spec, and does not authorize
another version bump by itself.
...
7. **PROMOTED AS v0.10.3:** correction is at most 0.090 inch
...
Future candidate changes compete against v0.10.3 on peak error, onset timing,
