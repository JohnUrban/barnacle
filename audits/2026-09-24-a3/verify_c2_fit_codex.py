...
out['dataset_hashes']={}
for k,rel in {'gfs_single_runs':'gfs_single_runs/runs.parquet','surge_6min_on_hour':'forecast_test/surge_hourly.parquet','verified_hourly_utc':'sandy_hook_hourly_utc.parquet','pressure_hourly_flags':'forecast_test/pressure_hourly_flags.parquet','previous_runs_gfs':'forecast_test/fcst_gfs_seamless.parquet'}.items():
