"""Independent round-05 checks; scratch-only outputs, no live network."""
...
# q changes the first flag's meaning: retained here as a defect reproduction.
rows=[]
...
assert all(x['output']['valid'] for x in out['quality_semantics'])
